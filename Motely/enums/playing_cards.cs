...
{
    Clubs = 0b00 << MotelyGlobals.PlayingCardSuitOffset,
    Diamonds = 0b01 << MotelyGlobals.PlayingCardSuitOffset,
    Hearts = 0b10 << MotelyGlobals.PlayingCardSuitOffset,
    Spades = 0b11 << MotelyGlobals.PlayingCardSuitOffset,
}
...
public static class MotelyPlayingCardSuitExt
{
    ...
    {
        return (int)suit >> MotelyGlobals.PlayingCardSuitOffset;
    }
}
...
public static class MotelyPlayingCardExt
{
    ...
    {
        return (MotelyPlayingCardSuit)((int)card & MotelyGlobals.PlayingCardSuitMask);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MotelyPlayingCardRank GetRank(this MotelyPlayingCard card)
    {
        return (MotelyPlayingCardRank)((int)card & MotelyGlobals.PlayingCardRankMask);
    }
}
