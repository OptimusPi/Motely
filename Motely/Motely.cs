...
public static partial class MotelyGlobals
{
    ...
    [
        // Spades
        new(MotelyStandardCard.S2),
        new(MotelyStandardCard.S3),
        new(MotelyStandardCard.S4),
        new(MotelyStandardCard.S5),
        new(MotelyStandardCard.S6),
        new(MotelyStandardCard.S7),
        new(MotelyStandardCard.S8),
        new(MotelyStandardCard.S9),
        new(MotelyStandardCard.S10),
        new(MotelyStandardCard.SJ),
        new(MotelyStandardCard.SQ),
        new(MotelyStandardCard.SK),
        new(MotelyStandardCard.SA),
        // Hearts
        new(MotelyStandardCard.H2),
        new(MotelyStandardCard.H3),
        new(MotelyStandardCard.H4),
        new(MotelyStandardCard.H5),
        new(MotelyStandardCard.H6),
        new(MotelyStandardCard.H7),
        new(MotelyStandardCard.H8),
        new(MotelyStandardCard.H9),
        new(MotelyStandardCard.H10),
        new(MotelyStandardCard.HJ),
        new(MotelyStandardCard.HQ),
        new(MotelyStandardCard.HK),
        new(MotelyStandardCard.HA),
        // Clubs
        new(MotelyStandardCard.C2),
        new(MotelyStandardCard.C3),
        new(MotelyStandardCard.C4),
        new(MotelyStandardCard.C5),
        new(MotelyStandardCard.C6),
        new(MotelyStandardCard.C7),
        new(MotelyStandardCard.C8),
        new(MotelyStandardCard.C9),
        new(MotelyStandardCard.C10),
        new(MotelyStandardCard.CJ),
        new(MotelyStandardCard.CQ),
        new(MotelyStandardCard.CK),
        new(MotelyStandardCard.CA),
        // Diamonds
        new(MotelyStandardCard.D2),
        new(MotelyStandardCard.D3),
        new(MotelyStandardCard.D4),
        new(MotelyStandardCard.D5),
        new(MotelyStandardCard.D6),
        new(MotelyStandardCard.D7),
        new(MotelyStandardCard.D8),
        new(MotelyStandardCard.D9),
        new(MotelyStandardCard.D10),
        new(MotelyStandardCard.DJ),
        new(MotelyStandardCard.DQ),
        new(MotelyStandardCard.DK),
        new(MotelyStandardCard.DA),
    ];
