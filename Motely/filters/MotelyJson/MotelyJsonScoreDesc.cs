...
/// </summary>
public struct MotelyJsonFinalTallyScoresDescDesc(
    MotelyJsonConfig Config, Action<string, int, int[]> OnResultFound, int Cutoff = 1, bool AutoCutoff = true
) : IMotelySeedFilterDesc<MotelyJsonFinalTallyScoresDescDesc.MotelyJsonFinalTallyScoresDesc>
{
