...
public readonly struct MotelyShopSlotMask
{
    ...
    public MotelyShopSlotMask(
        ulong bits0 = 0, ulong bits1 = 0, ulong bits2 = 0, ulong bits3 = 0,
        ulong bits4 = 0, ulong bits5 = 0, ulong bits6 = 0, ulong bits7 = 0,
        ulong bits8 = 0, ulong bits9 = 0, ulong bits10 = 0, ulong bits11 = 0,
        ulong bits12 = 0, ulong bits13 = 0, ulong bits14 = 0, ulong bits15 = 0)
    {
        _bits0 = bits0;
        _bits1 = bits1;
        _bits2 = bits2;
    ...
    public bool HasSlot(int slot)
    {
        ...
        {
            0 => _bits0, 1 => _bits1, 2 => _bits2, 3 => _bits3,
            4 => _bits4, 5 => _bits5, 6 => _bits6, 7 => _bits7,
            8 => _bits8, 9 => _bits9, 10 => _bits10, 11 => _bits11,
            12 => _bits12, 13 => _bits13, 14 => _bits14, 15 => _bits15,
            _ => 0
        };
