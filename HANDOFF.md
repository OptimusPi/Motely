...
- MCP App UI built (`tools/jaml-mcp/mcp-ui/dist/`)
...
- `tools/jaml-mcp/api/tools.ts` — MCP tool definitions
- `tools/jaml-mcp/public/.well-known/mcp/server-card.json` — MCP metadata
