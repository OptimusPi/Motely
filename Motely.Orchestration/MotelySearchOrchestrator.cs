...
namespace Motely.Executors
{
    ...
    public static class MotelySearchOrchestrator
    {
        ...
        )
        {
            if (global::Motely.Repository.RepositoryHost.Instance == null)
                throw new InvalidOperationException(
                    "Repository.Instance must be set to use database storage."
                );
            ...
            var database = global::Motely.Repository.RepositoryHost.Instance.GetSink(
                sinkMoniker,
                runConfig
            );
        ...
        private static IResultStorage ResolveSink(string moniker, MotelyRunConfig runConfig)
        {
            if (global::Motely.Repository.RepositoryHost.Instance == null)
                throw new InvalidOperationException(
                    "Repository.Instance must be set before creating result storage."
                );
