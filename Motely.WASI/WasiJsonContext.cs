...
public sealed class RpcRequest
{
    ...
    [JsonPropertyName("params")] public JsonParamsDto? Params { get; set; }
}
...
public sealed class JsonParamsDto
{
    ...
    [JsonPropertyName("randomSeeds")] public int? RandomSeeds { get; set; }
    [JsonPropertyName("cutoff")] public string? Cutoff { get; set; }
}
...
public sealed class WasiCapabilitiesDto
{
    ...
    [JsonPropertyName("simd")]           public bool Simd { get; set; }
    [JsonPropertyName("threads")]        public bool Threads { get; set; }
...
public sealed class WasiSeedAnalysisDto
{
    ...
    [JsonPropertyName("stake")] public string Stake { get; set; } = "";
    [JsonPropertyName("error")] public string? Error { get; set; }
    [JsonPropertyName("antes")] public WasiAnteDto[] Antes { get; set; } = [];
}

public sealed class WasiAnteDto
{
    [JsonPropertyName("ante")]          public int Ante { get; set; }
    [JsonPropertyName("boss")]          public string Boss { get; set; } = "";
    [JsonPropertyName("voucher")]       public string Voucher { get; set; } = "";
    [JsonPropertyName("smallBlindTag")] public string SmallBlindTag { get; set; } = "";
    [JsonPropertyName("bigBlindTag")]   public string BigBlindTag { get; set; } = "";
    [JsonPropertyName("shopQueue")]     public WasiShopItemDto[] ShopQueue { get; set; } = [];
    [JsonPropertyName("packs")]         public WasiPackDto[] Packs { get; set; } = [];
}
...
{
    [JsonPropertyName("type")] public string Type { get; set; } = "progress";
    [JsonPropertyName("seedsSearched")] public long SeedsSearched { get; set; }
    [JsonPropertyName("matchingSeeds")] public long MatchingSeeds { get; set; }
...
{
    [JsonPropertyName("type")] public string Type { get; set; } = "done";
