...
class Motely_BrowserWasm_JSMotelySearchHandle {
    constructor(_id) { this._id = _id; disposeOnFinalize(this, _id); }
    cancel() { Motely.BrowserWasm.MotelySearchHandle.cancel(this._id); }
    dispose() { Motely.BrowserWasm.MotelySearchHandle.dispose(this._id); }
}
...
const Motely = {
    ...
    BrowserWasm: {
        MotelyProgram: {
            ...
            createSeedRouter: (seed, deck, stake) => deserialize(getExports().Bootsharp_Generated_Exports_Motely_BrowserWasm_JSMotelyProgram_CreateSeedRouter(seed, serialize(deck), serialize(stake))),
            startConfiguredSearch: (jamlContent, threadCount, batchCharCount, startBatch, endBatch) => new Motely_BrowserWasm_JSMotelySearchHandle(getExports().Bootsharp_Generated_Exports_Motely_BrowserWasm_JSMotelyProgram_StartConfiguredSearch(jamlContent, threadCount, batchCharCount, startBatch, endBatch)),
            startSequentialSearch: (jamlContent, threadCount, batchCharCount, startBatch, endBatch) => new Motely_BrowserWasm_JSMotelySearchHandle(getExports().Bootsharp_Generated_Exports_Motely_BrowserWasm_JSMotelyProgram_StartSequentialSearch(jamlContent, threadCount, batchCharCount, startBatch, endBatch)),
            startRandomSearch: (jamlContent, randomSeedCount, threadCount, batchCharCount) => new Motely_BrowserWasm_JSMotelySearchHandle(getExports().Bootsharp_Generated_Exports_Motely_BrowserWasm_JSMotelyProgram_StartRandomSearch(jamlContent, randomSeedCount, threadCount, batchCharCount)),
            startAestheticSearch: (jamlContent, aesthetic, threadCount, batchCharCount) => new Motely_BrowserWasm_JSMotelySearchHandle(getExports().Bootsharp_Generated_Exports_Motely_BrowserWasm_JSMotelyProgram_StartAestheticSearch(jamlContent, aesthetic, threadCount, batchCharCount)),
            startKeywordSearch: (jamlContent, keywordsCsv, paddingChars, threadCount, batchCharCount) => new Motely_BrowserWasm_JSMotelySearchHandle(getExports().Bootsharp_Generated_Exports_Motely_BrowserWasm_JSMotelyProgram_StartKeywordSearch(jamlContent, keywordsCsv, paddingChars, threadCount, batchCharCount)),
            startSeedListSearch: (jamlContent, seedsCsv, threadCount) => new Motely_BrowserWasm_JSMotelySearchHandle(getExports().Bootsharp_Generated_Exports_Motely_BrowserWasm_JSMotelyProgram_StartSeedListSearch(jamlContent, seedsCsv, threadCount))
        },
        ...
        MotelySearchHandle: {
            cancel: (_id) => getExports().Bootsharp_Generated_Exports_Motely_BrowserWasm_JSMotelySearchHandle_Cancel(_id),
            dispose: (_id) => getExports().Bootsharp_Generated_Exports_Motely_BrowserWasm_JSMotelySearchHandle_Dispose(_id)
        }
    }
};
