import { CompletionItemKind, createConnection, DiagnosticSeverity, DidChangeConfigurationNotification, MarkupKind, ProposedFeatures, TextDocumentSyncKind, } from "vscode-languageserver/node.js";
...
function loadSchemaValues() {
    ...
    const clauseDefs = props.must?.items?.properties ??
