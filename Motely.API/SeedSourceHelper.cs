...
public static class SeedSourceHelper
{
    ...
    public static List<string> GenerateNsfwSeeds()
    {
        ...
        string[] nsfwWords = {
            // Profanity
            "FUK", "FUKK", "FUKKK", "SHIT", "SHT", "ASS", "ASSS",
            "DAMN", "HELL", "CRAP", "BITCH",
            // Sexual
            "SEX", "SEXX", "SEXY", "SEKS", "CUM", "CUMM", "CUMMY",
            "DIK", "DIKK", "DIKS", "COK", "COKK", "KOCK", "COCK",
            "TIT", "TITS", "TITT", "BOOB", "MILF", "SLUT", "HOE",
            "PORN", "PRN", "LEWD", "NUDE", "PAWG", "DTF", "BWC",
            "BBC", "VAG", "PUS", "NUT", "NUTS", "JERK",
            // Slurs (for detection testing)
            "FAG", "KUNT", "CVNT", "TWAT",
            // Drugs
            "WEED", "POT", "LSD", "DANK", "BLUNT", "HIGH", "BAKED",
            "STONER", "DOPE", "CRACK",
            // Other
            "KILL", "EVIL", "SATAN", "DEMON", "NAZI",
            // Silly/meme
            "LOL", "LMAO", "YEET", "BASED", "CHAD", "SIMP", "CRINGE"
        };
        
        // Number suffixes for padding
        string[] numSuffixes = { 
            "1", "11", "69", "88", "99", "111", "123", "321",
        ...
        {
            if (word.Length <= 8) seeds.Add(word);
        }
        ...
        foreach (var word in nsfwWords)
        {
            foreach (var suffix in numSuffixes)
            {
                ...
                if (combined.Length <= 8) seeds.Add(combined);
            }
        }
        ...
        string[] specialSeeds = {
            // Repeating patterns
            "69696969", "42069", "80085", "8008135", "58008",
            // Word combos
            "BIGDIK", "BIGCOK", "HOTMILF", "SEXGOD", "CUMKING",
            "DIKHEAD", "ASSHAT", "FUKFACE", "SHITASS",
            "CUMSHOT", "FUKBOY", "FUKBOI", "CUMSLUT",
            // X-padded
            "XSEXXX", "XXXPORN", "CUMXXX", "DIKXXX",
            // Meme combos
            "LOLCUM", "YEETDIK", "CHADCOK", "SIMPFUK",
            // Numbers mixed
            "CUM69", "SEX420", "DIK666", "FUK777",
            "69CUM", "420SEX", "666DIK", "777FUK",
            "CUM4ME", "DIK4U", "SEX4ALL",
            // All numbers that spell stuff
            "8008", "80085", "55378008"  // BOOB, BOOBS (upside down calc)
        };
        
        foreach (var seed in specialSeeds)
        {
            var normalized = ValidateAndNormalizeSeed(seed);
            if (normalized != null) seeds.Add(normalized);
        }
    ...
    public static bool IsNsfwSeed(string seed)
    {
        ...
        string[] patterns = {
            "FUK", "FCK", "SHT", "SHIT", "ASS", "DAMN", "HELL", "CRAP", "BITCH",
            "SEX", "SEKS", "CUM", "DIK", "COK", "COCK", "KOCK", "TIT", "BOOB",
            "MILF", "SLUT", "HOE", "PORN", "PRN", "LEWD", "NUDE", "PAWG", "DTF",
            "BWC", "BBC", "VAG", "PUS", "NUT", "JERK", "FAG", "KUNT", "CVNT",
            "CUNT", "TWAT", "WEED", "POT", "LSD", "DANK", "BLUNT", "CRACK",
            "KILL", "EVIL", "SATAN", "DEMON", "NAZI", "69", "420", "666"
        };
