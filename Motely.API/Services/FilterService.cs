...
public static class FilterService
{
    ...
    public static List<object> LoadFiltersFromDisk(
        string filtersPath,
        Func<global::Motely.Filters.MotelyJsonConfig?, bool> hasErraticFilters
    )
    {
        ...
        foreach (var file in filterFiles)
        {
            ...
            string? jamlErr;
            if (
                JamlConfigLoader.TryLoadFromJamlString(filterJaml, out var cfg, out jamlErr)
                && cfg != null
            )
            {
