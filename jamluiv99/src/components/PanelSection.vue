...
const props = defineProps({
  color: {
    type: String,
    default: 'red',
    validator: (v) => ['red', 'blue', 'green', 'purple', 'orange', 'jimbo'].includes(v)
  },
  label: {
    type: String,
    required: true
...
/* Jimbo (TUI) theme: gold/slate poker-table accent */
.panel-section-jimbo {
  --panel-color: var(--balatro-gold);
  --panel-color-dark: var(--balatro-dark-gold);
}
</style>
