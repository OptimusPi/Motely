...
export const Editions: Story = {
  render: () => (
    <div style={{ display: "grid", gap: 16, gridAutoFlow: "column", justifyContent: "start" }}>
      <JamlGameCard card={{ name: "Joker", scale: 1.5 }} type="joker" />
      <JamlGameCard card={{ name: "Joker", edition: "Foil", scale: 1.5 }} type="joker" />
      <JamlGameCard card={{ name: "Joker", edition: "Holographic", scale: 1.5 }} type="joker" />
      <JamlGameCard card={{ name: "Joker", edition: "Polychrome", scale: 1.5 }} type="joker" />
      <JamlGameCard card={{ name: "Joker", edition: "Negative", scale: 1.5 }} type="joker" />
    </div>
  ),
};
...
export const Stickers: Story = {
  render: () => (
    <div style={{ display: "grid", gap: 16, gridAutoFlow: "column", justifyContent: "start" }}>
      <JamlGameCard card={{ name: "Joker", isEternal: true, scale: 1.5 }} type="joker" />
      <JamlGameCard card={{ name: "Joker", isPerishable: true, scale: 1.5 }} type="joker" />
      <JamlGameCard card={{ name: "Joker", isRental: true, scale: 1.5 }} type="joker" />
      <JamlGameCard
        card={{ name: "Joker", isEternal: true, isPerishable: true, isRental: true, scale: 1.5 }}
        type="joker"
      />
    </div>
  ),
...
export const EnhancementsAndSeals: Story = {
  render: () => (
    <div style={{ display: "grid", gap: 16, gridAutoFlow: "column", justifyContent: "start" }}>
      <JamlGameCard card={{ name: "Ace of Hearts", rank: "Ace", suit: "Hearts", scale: 1.5 }} type="playing" />
      <JamlGameCard
        card={{ name: "Ace of Hearts", rank: "Ace", suit: "Hearts", enhancements: ["Glass"], scale: 1.5 }}
        type="playing"
      />
      <JamlGameCard
        card={{ name: "Ace of Hearts", rank: "Ace", suit: "Hearts", seal: "Red Seal", scale: 1.5 }}
        type="playing"
      />
      <JamlGameCard
        card={{ name: "Ace of Hearts", rank: "Ace", suit: "Hearts", enhancements: ["Steel"], seal: "Gold Seal", scale: 1.5 }}
        type="playing"
      />
    </div>
  ),
...
export const NameParsing: Story = {
  render: () => (
    <div style={{ display: "grid", gap: 16, gridAutoFlow: "column", justifyContent: "start" }}>
      <JamlGameCard card={{ name: "King of Clubs", scale: 1.5 }} type="playing" />
      <JamlGameCard card={{ name: "KC", scale: 1.5 }} type="playing" />
      <JamlGameCard card={{ name: "10 of Diamonds", scale: 1.5 }} type="playing" />
      <JamlGameCard card={{ name: "ignored", rank: "Queen", suit: "Spades", scale: 1.5 }} type="playing" />
    </div>
  ),
};
...
export const Scales: Story = {
  render: () => (
    <div style={{ display: "grid", gap: 16, gridAutoFlow: "column", justifyContent: "start", alignItems: "end" }}>
      <JamlGameCard card={{ name: "Joker", scale: 0.5 }} type="joker" />
...
export const UnknownName: Story = {
  args: { card: { name: "Not A Real Joker", scale: 1.5 }, type: "joker" },
};
