...
/// <summary>
/// Locks the JSON Schema emitted by <see cref="JamlSchemaGenerator.Generate"/> against a
...
public class JamlSchemaSnapshotTests
{
  ...
  {
    var current = JamlSchemaGenerator.Generate().ToJsonString(new JsonSerializerOptions
    {
      WriteIndented = true,
