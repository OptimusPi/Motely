...
public static class SearchTestHelpers
{
    ...
    public static void AwaitCompletionWithTimeout(this IMotelySearch search, int timeoutSeconds = 30)
    {
        ...
        var joinTimeout = remainingTimeout > TimeSpan.Zero ? remainingTimeout : TimeSpan.FromSeconds(1);
