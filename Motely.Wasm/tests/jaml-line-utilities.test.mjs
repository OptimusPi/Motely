...
describe("MotelyUtilities", () => {
    ...
    it("pins keyword aesthetic counts and keyword validity", () => {
        assert.equal(MotelyUtilities.getAestheticSeedCount(JamlAesthetic.Gross), 183030995n);
        assert.equal(MotelyUtilities.getAestheticSeedCount(JamlAesthetic.Funny), 312463270n);
        assert.equal(MotelyUtilities.getAestheticSeedCount(JamlAesthetic.Balatro), 290680670n);
